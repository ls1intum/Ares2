...
public class FileChannelRead {
	...
	/**
	 * Access the file system using FileChannel.read(ByteBuffer) for
	 * high-throughput, seekable byte stream reading. Test Case:
	 * FileChannel.read(ByteBuffer) - High-throughput read into a buffer; supports
	 * random access
	 */
