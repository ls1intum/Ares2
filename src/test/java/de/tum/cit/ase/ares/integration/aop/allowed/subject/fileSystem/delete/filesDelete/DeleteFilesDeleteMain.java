...
public final class DeleteFilesDeleteMain {
    ...
    public static void accessFileSystemViaFilesDelete() throws IOException {
        Files.delete(Path.of("src/test/java/de/tum/cit/ase/ares/integration/aop/allowed/subject/trusted.txt"));
    }

    public static void accessFileSystemViaFilesDeleteIfExists() throws IOException {
        Files.deleteIfExists(Path.of("src/test/java/de/tum/cit/ase/ares/integration/aop/allowed/subject/trusted.txt"));
    }
}
