 ...
 * ensures consistent 100 percent coverage.
 *
 * @since 2.0.0
...
public class JavaAOPTestCaseSupportedTest {
	 ...
	 * sequence of constants aligns with their declaration in the source code, and
	 * that each enum constant is an instance of AOPTestCaseSupported.
	 *
	 * @since 2.0.0
	 * @author Markus Paulsen
	 */
	 ...
	 * the same sequence as they are declared, and that the result is not null.
	 *
	 * @since 2.0.0
	 * @author Markus Paulsen
	 */
