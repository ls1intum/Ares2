package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.zipInputStream;
...
public class ZipInputStreamReadMain {
	...
	public static int accessFileSystemViaZipInputStreamRead() throws IOException {
		try (ZipInputStream reader = new ZipInputStream(new FileInputStream(
