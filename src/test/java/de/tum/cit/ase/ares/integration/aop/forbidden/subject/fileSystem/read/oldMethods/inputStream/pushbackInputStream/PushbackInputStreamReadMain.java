package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.pushbackInputStream;
...
public class PushbackInputStreamReadMain {
	...
	public static int accessFileSystemViaPushbackInputStreamRead() throws IOException {
		try (PushbackInputStream reader = new PushbackInputStream(new FileInputStream(
