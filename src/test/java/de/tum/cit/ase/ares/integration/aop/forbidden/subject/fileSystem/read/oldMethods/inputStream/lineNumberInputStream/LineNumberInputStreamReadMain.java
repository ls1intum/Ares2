package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.lineNumberInputStream;
...
public class LineNumberInputStreamReadMain {
	...
	public static int accessFileSystemViaLineNumberInputStreamRead() throws IOException {
		try (LineNumberInputStream reader = new LineNumberInputStream(new FileInputStream(
