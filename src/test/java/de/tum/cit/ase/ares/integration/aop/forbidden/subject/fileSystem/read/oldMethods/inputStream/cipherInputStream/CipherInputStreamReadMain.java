package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.cipherInputStream;
...
public class CipherInputStreamReadMain {
	...
	public static int accessFileSystemViaCipherInputStreamRead() throws IOException, GeneralSecurityException {
		try (CipherInputStream reader = new CipherInputStream(
				new FileInputStream(
	...
	public static int accessFileSystemViaCipherInputStreamReadByteArrayOffsetLength()
	...
	public static byte[] accessFileSystemViaCipherInputStreamReadAllBytes()
			throws IOException, GeneralSecurityException {
		try (CipherInputStream reader = new CipherInputStream(
				new FileInputStream(
						"src/test/java/de/tum/cit/ase/ares/integration/aop/forbidden/subject/nottrusted.txt"),
