...
public class FileHandlerConstantsTest {
	...
	void testArchunitFilesystemMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_FILESYSTEM_METHODS,
	...
	void testArchunitNetworkMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_NETWORK_METHODS,
	...
	void testArchunitJvmTerminationMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_JVM_TERMINATION_METHODS,
	...
	void testArchunitReflectionMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_REFLECTION_METHODS,
	...
	void testArchunitCommandExecutionMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_COMMAND_EXECUTION_METHODS,
	...
	void testArchunitThreadManipulationMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_THREAD_MANIPULATION_METHODS,
	...
	void testArchunitSerializationMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_SERIALIZATION_METHODS,
	...
	void testArchunitClassLoaderMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.ARCHUNIT_CLASSLOADER_METHODS,
	...
	void testWalaClassLoaderMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_CLASSLOADER_METHODS,
	...
	void testWalaFilesystemMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_FILESYSTEM_METHODS,
	...
	void testWalaNetworkMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_NETWORK_METHODS,
	...
	void testWalaJvmMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_JVM_TERMINATION_METHODS,
	...
	void testWalaReflectionMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_REFLECTION_METHODS,
	...
	void testWalaCommandExecutionMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_COMMAND_EXECUTION_METHODS,
	...
	void testWalaSerializationMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_SERIALIZATION_METHODS,
	...
	void testWalaThreadManipulationMethodsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.WALA_THREAD_MANIPULATION_METHODS,
	...
	void testFalsePositivesFileSystemInteractionsConstant() {
		...
		assertEquals(expected, FileHandlerConstants.FALSE_POSITIVES_FILE_SYSTEM_INTERACTIONS,
