...
class FileSystemAccessReadTest extends SystemAccessTest {
	...
	void test_accessFileSystemViaInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(InputStream::accessFileSystemViaInputStreamRead, InputStream.class);
	}
	...
	void test_accessFileSystemViaInputStreamAvailableMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(InputStream::accessFileSystemViaInputStreamAvailable, InputStream.class);
	}
	...
	void test_accessFileSystemViaInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(InputStream::accessFileSystemViaInputStreamReadAllBytes, InputStream.class);
	}
	...
	void test_accessFileSystemViaDataInputStreamMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DataInputStream::accessFileSystemViaDataInputStream, DataInputStream.class);
	}
	...
	void test_accessFileSystemViaFileReaderMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileReader::accessFileSystemViaFileReader, FileReader.class);
	}
	...
	void test_accessFileSystemViaReaderMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(Reader::accessFileSystemViaReader, Reader.class);
	}
	...
	// <editor-fold desc="accessFileSystemViaReaderConstructor">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = CHARACTER_READER_WITHIN_PATH)
	void test_accessFileSystemViaReaderConstructorMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(Reader::accessFileSystemViaReaderConstructor, Reader.class);
	}

	@PublicTest
	@Policy(value = ARCHUNIT_INSTRUMENTATION_POLICY_ONE_PATH_ALLOWED_READ, withinPath = CHARACTER_READER_WITHIN_PATH)
	void test_accessFileSystemViaReaderConstructorMavenArchunitInstrumentation() {
		assertAresSecurityExceptionRead(Reader::accessFileSystemViaReaderConstructor, Reader.class);
	}

	@PublicTest
	@Policy(value = WALA_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = CHARACTER_READER_WITHIN_PATH)
	void test_accessFileSystemViaReaderConstructorMavenWalaAspectJ() {
		assertAresSecurityExceptionRead(Reader::accessFileSystemViaReaderConstructor, Reader.class);
	}

	@PublicTest
	@Policy(value = WALA_INSTRUMENTATION_POLICY_ONE_PATH_ALLOWED_READ, withinPath = CHARACTER_READER_WITHIN_PATH)
	void test_accessFileSystemViaReaderConstructorMavenWalaInstrumentation() {
		assertAresSecurityExceptionRead(Reader::accessFileSystemViaReaderConstructor, Reader.class);
	}
	// </editor-fold>
	...
	void test_accessFileSystemViaScannerMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ScannerReader::accessFileSystemViaScanner, ScannerReader.class);
	}
	...
	void test_accessFileSystemViaFilesReadStringMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadString::accessFileSystemViaFilesReadString, FilesReadString.class);
	}
	...
	void test_accessFileSystemViaFilesLinesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesLines::accessFileSystemViaFilesLines, FilesLines.class);
	}
	...
	void test_accessFileSystemViaFileChannelReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileChannelRead::accessFileSystemViaFileChannelRead, FileChannelRead.class);
	}
	...
	void test_accessFileSystemViaFileChannelMapMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileChannelRead::accessFileSystemViaFileChannelMap, FileChannelRead.class);
	}
