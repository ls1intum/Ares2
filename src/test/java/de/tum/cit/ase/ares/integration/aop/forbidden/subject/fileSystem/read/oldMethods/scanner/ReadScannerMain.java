package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.scanner;
...
public class ReadScannerMain {
	...
	/**
	 * Access the file system using Scanner(File source, String charsetName)
	 * constructor.
	 */
	...
	/**
	 * Access the file system using Scanner(File source, Charset charset)
	 * constructor.
	 */
	...
	/**
	 * Access the file system using Scanner(Path source, String charsetName)
	 * constructor.
	 */
	...
	/**
	 * Access the file system using Scanner(Path source, Charset charset)
	 * constructor.
	 */
