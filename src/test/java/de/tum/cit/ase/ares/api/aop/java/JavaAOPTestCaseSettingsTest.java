...
public class JavaAOPTestCaseSettingsTest {
	...
	public void testClassStructureAndConstructor() {
		...
		Assertions.assertAll("class structure", () -> Assertions.assertEquals(0, publicConstructors.length, "There must be no public constructors"),
		...
		InvocationTargetException thrown = Assertions.assertThrows(InvocationTargetException.class, constructor::newInstance, "Invoking private constructor must throw SecurityException");
		constructor.setAccessible(false);
		Assertions.assertTrue(thrown.getTargetException().getMessage().contains("Ares Security Error"), "Exception message must indicate security error");
	}
	...
	public void testResetResetsAllFields() throws Exception {
		Class<JavaAOPTestCaseSettings> clazz = JavaAOPTestCaseSettings.class;
		Map<String, Object> samples = Map.ofEntries(Map.entry("buildMode", "Maven"), Map.entry("architectureMode", "Archunit"), Map.entry("aopMode", "Aspectj"),
				Map.entry("restrictedPackage", "de.tum.cit.ase"), Map.entry("mainClass", "Main"), Map.entry("allowedListedPackages", new String[]{ "pkg1" }),
				Map.entry("allowedListedClasses", new String[]{ "Cls1" }), Map.entry("pathsAllowedToBeRead", new String[]{ "/read" }),
				Map.entry("pathsAllowedToBeOverwritten", new String[]{ "/overwrite" }), Map.entry("pathsAllowedToBeExecuted", new String[]{ "/exec" }),
				Map.entry("pathsAllowedToBeDeleted", new String[]{ "/delete" }), Map.entry("hostsAllowedToBeConnectedTo", new String[]{ "host" }),
				Map.entry("portsAllowedToBeConnectedTo", new int[]{ 8080 }), Map.entry("hostsAllowedToBeSentTo", new String[]{ "sendHost" }), Map.entry("portsAllowedToBeSentTo", new int[]{ 443 }),
				Map.entry("hostsAllowedToBeReceivedFrom", new String[]{ "recvHost" }), Map.entry("portsAllowedToBeReceivedFrom", new int[]{ 22 }),
				Map.entry("commandsAllowedToBeExecuted", new String[]{ "cmd" }), Map.entry("argumentsAllowedToBePassed", new String[][]{ { "arg1" } }),
				Map.entry("threadClassAllowedToBeCreated", new String[]{ "ThreadCls" }), Map.entry("threadNumberAllowedToBeCreated", new int[]{ 5 }));
