...
class FileSystemAccessExecuteTest extends SystemAccessTest {
	...
	void test_accessFileSystemViaRuntimeMavenArchunitAspectJ() {
		assertAresSecurityExceptionExecution(RuntimeExecuteMain::accessFileSystemViaRuntime, RuntimeExecuteMain.class);
	}
	...
	void test_accessFileSystemViaDesktopMavenArchunitAspectJ() {
		assertAresSecurityExceptionExecution(DesktopExecuteMain::accessFileSystemViaDesktop, DesktopExecuteMain.class);
	}
	...
	void test_accessFileSystemViaDesktopBrowseMavenArchunitAspectJ() {
		assertAresSecurityExceptionExecution(DesktopExecuteMain::accessFileSystemViaDesktopBrowse, DesktopExecuteMain.class);
	}
	...
	void test_accessFileSystemViaDesktopBrowseFileDirectoryMavenArchunitAspectJ() {
		assertAresSecurityExceptionExecution(DesktopExecuteMain::accessFileSystemViaDesktopBrowseFileDirectory,
	...
	void test_accessFileSystemViaDesktopEditMavenArchunitAspectJ() {
		assertAresSecurityExceptionExecution(DesktopExecuteMain::accessFileSystemViaDesktopEdit, DesktopExecuteMain.class);
	}
	...
	void test_accessFileSystemViaDesktopPrintMavenArchunitAspectJ() {
		assertAresSecurityExceptionExecution(DesktopExecuteMain::accessFileSystemViaDesktopPrint, DesktopExecuteMain.class);
	}
