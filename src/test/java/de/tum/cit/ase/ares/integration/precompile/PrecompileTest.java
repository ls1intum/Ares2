...
public class PrecompileTest {
	/*
	 * @BeforeEach void clean() { Path target =
	 * Paths.get("src/test/resources/dump"); if (!Files.exists(target) ||
	 * !Files.isDirectory(target)) {
	 * System.err.println("Target path does not exist or is not a directory: " +
