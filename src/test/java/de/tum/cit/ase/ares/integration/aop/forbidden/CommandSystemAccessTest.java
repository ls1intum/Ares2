...
/**
 * Integration tests to verify that command system execution is forbidden when
 * trying to execute commands that are not allowed by the security policy, even
 * when some commands are permitted.
 */
