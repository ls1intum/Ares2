...
/**
 * This test class tests the file system access of the test user. We are not
 * using the usual Ares testing style, since the agent works on the current
 * running tests, user based tests are not working as expected
 */
...
class FileSystemAccessTest {
	...
	// TODO Markus: Look into why we cannot structure the rest of the tests like
	// "Other Tests"
	...
	// tests.assertThatEvents().haveExactly(1,
	// finishedSuccessfully(accessPathNormalAllowed));
	// }

	// @TestTest
	// void test_accessPathRelativeGlobA() {
	// tests.assertThatEvents().haveExactly(1,
	// finishedSuccessfully(accessPathRelativeGlobA));
	// }
	//
	// @TestTest
	// void test_accessPathRelativeGlobB() {
	// tests.assertThatEvents().haveExactly(1,
	// finishedSuccessfully(accessPathRelativeGlobB));
	// }
	//
	// @TestTest
	// void test_accessPathRelativeGlobDirectChildrenAllowed() {
	// tests.assertThatEvents().haveExactly(1,
	// finishedSuccessfully(accessPathRelativeGlobDirectChildrenAllowed));
	// }
	...
	void test_accessPathRelativeGlobDirectChildrenBlacklist() {
		...
		// tests.assertThatEvents().haveExactly(1,
		// testFailedWith(accessPathRelativeGlobDirectChildrenBlacklist,
		// SecurityException.class));
	}
	...
	void test_accessPathRelativeGlobDirectChildrenForbidden() {
		// tests.assertThatEvents().haveExactly(1,
		// testFailedWith(accessPathRelativeGlobDirectChildrenForbidden,
		// SecurityException.class));
	}
	...
	// tests.assertThatEvents().haveExactly(1,
	// finishedSuccessfully(accessPathRelativeGlobRecursiveAllowed));
	// }
	...
	void test_accessPathRelativeGlobRecursiveBlacklist() {
		// OUTCOMMENTED: Test does not pass
		// tests.assertThatEvents().haveExactly(1,
		// testFailedWith(accessPathRelativeGlobRecursiveBlacklist,
		// SecurityException.class));
	}
	...
	void test_accessPathRelativeGlobRecursiveForbidden() {
		// tests.assertThatEvents().haveExactly(1,
		// testFailedWith(accessPathRelativeGlobRecursiveForbidden,
		// SecurityException.class));
	}
	...
	void test_accessPathTest() {
		// OUTCOMMENTED: Test does not pass
		// tests.assertThatEvents().haveExactly(1, testFailedWith(accessPathTest,
		// SecurityException.class));
	}
