...
class FileSystemAccessTest {
    ...
    class ReadOperations {
        ...
        void test_accessFileSystemViaBufferedReaderReadMavenArchunitAspectJ() {
            assertAresSecurityExceptionRead(ReadBufferedReaderMain::accessFileSystemViaBufferedReaderRead,
        ...
        void test_accessFileSystemViaBufferedReaderReadCharArrayMavenArchunitAspectJ() {
            assertAresSecurityExceptionRead(ReadBufferedReaderMain::accessFileSystemViaBufferedReaderReadCharArray,
                    ReadBufferedReaderMain.class);
        }
        ...
        void test_accessFileSystemViaBufferedReaderReadLineMavenArchunitAspectJ() {
            assertAresSecurityExceptionRead(ReadBufferedReaderMain::accessFileSystemViaBufferedReaderReadLine,
                    ReadBufferedReaderMain.class);
        }
        ...
        // <editor-fold desc="accessFileSystemViaInputStreamReader (InputStreamReader)">
        @PublicTest
        ...
        // <editor-fold desc="accessFileSystemViaObjectInputStream (ObjectInputStream)">
        @PublicTest
        ...
        // <editor-fold desc="accessFileSystemViaLineNumberReader (LineNumberReader)">
        @PublicTest
        @Policy(value = "src/test/resources/de/tum/cit/ase/ares/integration/testuser/securitypolicies/java/maven/archunit/aspectj/PolicyOnePathAllowedRead.yaml", withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/lineNumberReader")
        void test_accessFileSystemViaLineNumberReaderMavenArchunitAspectJ() {
            assertAresSecurityExceptionRead(ReadLineNumberReaderMain::accessFileSystemViaLineNumberReader, ReadLineNumberReaderMain.class);
        }

        @PublicTest
        @Policy(value = "src/test/resources/de/tum/cit/ase/ares/integration/testuser/securitypolicies/java/maven/archunit/instrumentation/PolicyOnePathAllowedRead.yaml", withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/lineNumberReader")
        void test_accessFileSystemViaLineNumberReaderMavenArchunitInstrumentation() {
            assertAresSecurityExceptionRead(ReadLineNumberReaderMain::accessFileSystemViaLineNumberReader, ReadLineNumberReaderMain.class);
        }

        @PublicTest
        @Policy(value = "src/test/resources/de/tum/cit/ase/ares/integration/testuser/securitypolicies/java/maven/wala/aspectj/PolicyOnePathAllowedRead.yaml", withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/lineNumberReader")
        void test_accessFileSystemViaLineNumberReaderMavenWalaAspectJ() {
            assertAresSecurityExceptionRead(ReadLineNumberReaderMain::accessFileSystemViaLineNumberReader, ReadLineNumberReaderMain.class);
        }

        @PublicTest
        @Policy(value = "src/test/resources/de/tum/cit/ase/ares/integration/testuser/securitypolicies/java/maven/wala/instrumentation/PolicyOnePathAllowedRead.yaml", withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/lineNumberReader")
        void test_accessFileSystemViaLineNumberReaderMavenWalaInstrumentation() {
            assertAresSecurityExceptionRead(ReadLineNumberReaderMain::accessFileSystemViaLineNumberReader, ReadLineNumberReaderMain.class);
        }
        // </editor-fold>

        // <editor-fold desc="accessFileSystemViaFileInputStream (FileInputStream)">
        @PublicTest
        ...
        // <editor-fold desc="accessFileSystemViaDataInputStream (DataInputStream)">
        @PublicTest
        ...
        void test_accessFileSystemViaFileReaderReadMavenArchunitAspectJ() {
            assertAresSecurityExceptionRead(ReadFileReaderMain::accessFileSystemViaFileReaderRead,
        ...
        // <editor-fold desc="accessFileSystemViaNIOChannel (NIO FileChannel)">
        @PublicTest
