...
public class WriteNIOChannelMain {
	...
	public static void accessFileSystemViaNIOChannel(String text) throws IOException {
		try (FileChannel channel = FileChannel.open(Path.of("src/test/java/de/tum/cit/ase/ares/integration/aop/allowed/subject/trusted.txt"), StandardOpenOption.CREATE, StandardOpenOption.WRITE)) {
