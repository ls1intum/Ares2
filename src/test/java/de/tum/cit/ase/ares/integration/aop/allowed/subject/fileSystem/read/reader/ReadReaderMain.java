...
public class ReadReaderMain {
	...
	public static void accessFileSystemViaReaderRead() throws IOException {
		try (Reader reader = new FileReader(
				"src/test/java/de/tum/cit/ase/ares/integration/aop/allowed/subject/fileSystem/read/reader/trustedFile.txt")) {
	...
	/**
	 * Access the file system using Reader.read(char[] cbuf, int off, int len)
	 * method.
	 */
