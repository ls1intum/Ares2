package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.fileCacheImageInputStream;
...
public class FileCacheImageInputStreamReadMain {
	...
	public static int accessFileSystemViaFileCacheImageInputStreamRead() throws IOException {
		try (FileCacheImageInputStream reader = new FileCacheImageInputStream(new FileInputStream("src/test/java/de/tum/cit/ase/ares/integration/aop/forbidden/subject/nottrusted.txt"),
