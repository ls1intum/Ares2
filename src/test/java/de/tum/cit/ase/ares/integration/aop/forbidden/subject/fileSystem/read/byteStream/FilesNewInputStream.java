...
public class FilesNewInputStream {
	...
	/**
	 * Access the file system using Files.newInputStream(Path) for low-level byte
	 * stream reading. Test Case: Files.newInputStream(Path) - Low-level byte stream
	 * (respects OpenOptions)
	 */
