...
public class CipherOutputStreamWriteMain {
	...
	/**
	 * Access the file system using {@link CipherOutputStream} for single‑byte
	 * write.
	 */
	public static void accessFileSystemViaCipherOutputStream()
	...
	public static void accessFileSystemViaCipherOutputStreamWithData()
			throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
		Cipher cipher = getCipher();
		try (CipherOutputStream cos = new CipherOutputStream(new FileOutputStream(NOT_TRUSTED_FILE), cipher)) {
	...
	public static void accessFileSystemViaCipherOutputStreamWithDataAndOffset()
			throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
		Cipher cipher = getCipher();
		try (CipherOutputStream cos = new CipherOutputStream(new FileOutputStream(NOT_TRUSTED_FILE), cipher)) {
