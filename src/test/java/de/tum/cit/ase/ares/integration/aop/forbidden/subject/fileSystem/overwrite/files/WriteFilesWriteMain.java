...
public final class WriteFilesWriteMain {
	...
	/**
	 * Access the file system using the
	 * {@link Files#write(Path, byte[], OpenOption...)} method.
	 */
	...
	/**
	 * Access the file system using the
	 * {@link Files#write(Path, Iterable, Charset, OpenOption...)} method.
	 */
	...
	/**
	 * Access the file system using the
	 * {@link Files#write(Path, Iterable, OpenOption...)} method.
	 */
	...
	/**
	 * Access the file system using the
	 * {@link Files#writeString(Path, CharSequence, Charset, OpenOption...)} method.
	 */
	...
	/**
	 * Access the file system using the
	 * {@link Files#writeString(Path, CharSequence, OpenOption...)} method.
	 */
	...
	/**
	 * Access the file system using the
	 * {@link Files#copy(Path, Path, CopyOption...)} method.
	 */
	...
	/**
	 * Access the file system using the
	 * {@link Files#move(Path, Path, CopyOption...)} method.
	 */
