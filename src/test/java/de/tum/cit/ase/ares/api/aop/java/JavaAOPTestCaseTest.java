...
class JavaAOPTestCaseTest {
	...
	void testGenerateAdviceSettingValueTriple() {
		JavaAOPAdviceSettingTriple triple = new JavaAOPAdviceSettingTriple("String", "foo", null);
	...
	void testGenerateAdviceSettingValueUnknownTypeThrows() {
		assertThrows(RuntimeException.class, () -> invokeGenerate("Unknown", "x", "value"));
	}
	...
	void testSetJavaAdviceSettingValueHappyPathOtherMode() throws Exception {
		...
		JavaAOPTestCase.setJavaAdviceSettingValue(field, "xyz", "ARCH", "ASPECTJ");
	...
	void testBuilderHappyPath() {
		...
		assertSame(supplier, tc.getResourceAccessSupplier());
	...
	void testExecuteAOPTestCaseNetwork() throws Exception {
		...
		Field fHosts = JavaAOPTestCaseSettings.class.getDeclaredField("hostsAllowedToBeConnectedTo");
	...
	void testExecuteAOPTestCaseCommand() throws Exception {
		...
		Field fCmd = JavaAOPTestCaseSettings.class.getDeclaredField("commandsAllowedToBeExecuted");
	...
	void testExecuteAOPTestCaseThread() throws Exception {
		...
		Field fNum = JavaAOPTestCaseSettings.class.getDeclaredField("threadNumberAllowedToBeCreated");
	...
	// Helper to invoke private static generateAdviceSettingValue(String, String,
	// Object)
	...
	// Helper to invoke private static
