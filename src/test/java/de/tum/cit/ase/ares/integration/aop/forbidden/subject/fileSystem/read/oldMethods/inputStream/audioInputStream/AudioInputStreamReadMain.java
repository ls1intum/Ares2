...
public class AudioInputStreamReadMain {
	...
	public static int accessFileSystemViaAudioInputStreamRead() throws IOException {
		try (FileInputStream fis = new FileInputStream("src/test/java/de/tum/cit/ase/ares/integration/aop/forbidden/subject/nottrusted.txt"); AudioInputStream reader = getAudioInputStream(fis)) {
			return reader.read();
		}
	}
