package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.bufferedReader;
...
public class ReadBufferedReaderMain {
	...
	/**
	 * Access the file system using BufferedReader.read() Reads the file character
	 * by character.
	 */
	...
	/**
	 * Access the file system using BufferedReader.read(char[] cbuf, int off, int
