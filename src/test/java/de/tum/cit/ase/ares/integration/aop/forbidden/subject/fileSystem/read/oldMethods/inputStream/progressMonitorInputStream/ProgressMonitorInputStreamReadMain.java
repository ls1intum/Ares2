package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.progressMonitorInputStream;
...
public class ProgressMonitorInputStreamReadMain {
	...
	public static int accessFileSystemViaProgressMonitorInputStreamRead() throws IOException {
		try (ProgressMonitorInputStream reader = new ProgressMonitorInputStream(null, "Reading", new FileInputStream(
