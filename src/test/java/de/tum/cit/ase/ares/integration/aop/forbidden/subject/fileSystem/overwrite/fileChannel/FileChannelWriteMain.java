...
public class FileChannelWriteMain {
	...
	private static final String NOT_TRUSTED_FILE_DIR = "src/test/java/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/overwrite/nottrusteddir";
	...
	/**
	 * Access the file system using NIO {@link FileChannel#write(ByteBuffer)} for
	 * writing. This is already demonstrated in accessFileSystemViaNIOChannel but
	...
	/**
	 * Access the file system using NIO
	...
	/**
	 * Access the file system using NIO {@link FileChannel#write(ByteBuffer, long)}
	...
	/**
	 * Access the file system using NIO {@link FileChannel#truncate(long)} to resize
	 * a file.
	 */
	...
	/**
	 * Access the file system using NIO
	 * {@link FileChannel#transferTo(long, long, WritableByteChannel)} to transfer
