package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.checkedInputStream;
...
public class CheckedInputStreamReadMain {
	...
	public static int accessFileSystemViaCheckedInputStreamRead() throws IOException {
		try (CheckedInputStream reader = new CheckedInputStream(
				new FileInputStream(
