...
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.fileChannel.FileChannelReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.files.FilesReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.audioInputStream.AudioInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.bufferedInputStream.BufferedInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.checkedInputStream.CheckedInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.cipherInputStream.CipherInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.dataInputStream.DataInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.deflaterInputStream.DeflaterInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.digestInputStream.DigestInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.fileCacheImageInputStream.FileCacheImageInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.fileImageInputStream.FileImageInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.fileInputStream.FileInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.filterInputStream.FilterInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.gZIPInputStream.GZIPInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.imageInputStreamImpl.ImageInputStreamImplReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.inflaterInputStream.InflaterInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.jarInputStream.JarInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.lineNumberInputStream.LineNumberInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.memoryCacheImageInputStream.MemoryCacheImageInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.objectInputStream.ObjectInputStreamReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.properties.ReadPropertiesMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.randomAccessFile.RandomAccessFileReadMain;
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.reader.bufferedReader.BufferedReaderReadMain;
...
import de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.scanner.ReadScannerMain;
...
class FileSystemAccessReadTestOld extends SystemAccessTest {
	...
	void test_accessFileSystemViaFileInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileInputStreamReadMain::accessFileSystemViaFileInputStreamReadAllBytes,
				FileInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileInputStreamReadMain::accessFileSystemViaFileInputStreamReadNBytes,
				FileInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFilesReadStringMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadMain::accessFileSystemViaFilesReadString, FilesReadMain.class);
	}
	...
	void test_accessFileSystemViaFilesNewBufferedReaderMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadMain::accessFileSystemViaFilesNewBufferedReader, FilesReadMain.class);
	}
	...
	void test_accessFileSystemViaFilesNewInputStreamMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadMain::accessFileSystemViaFilesNewInputStream, FilesReadMain.class);
	}
	...
	void test_accessFileSystemViaFilesNewByteChannelMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadMain::accessFileSystemViaFilesNewByteChannel, FilesReadMain.class);
	}
	...
	void test_accessFileSystemViaFilesMismatchMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadMain::accessFileSystemViaFilesMismatch, FilesReadMain.class);
	}
	...
	void test_accessFileSystemViaAudioInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(AudioInputStreamReadMain::accessFileSystemViaAudioInputStreamRead,
	...
	void test_accessFileSystemViaAudioInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(AudioInputStreamReadMain::accessFileSystemViaAudioInputStreamReadByteArray,
				AudioInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaAudioInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(AudioInputStreamReadMain::accessFileSystemViaAudioInputStreamReadAllBytes,
				AudioInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaAudioInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(AudioInputStreamReadMain::accessFileSystemViaAudioInputStreamReadNBytes,
				AudioInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaBufferedInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(BufferedInputStreamReadMain::accessFileSystemViaBufferedInputStreamRead,
				BufferedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaBufferedInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				BufferedInputStreamReadMain::accessFileSystemViaBufferedInputStreamReadByteArray,
				BufferedInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaBufferedInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/bufferedInputStream")
	void test_accessFileSystemViaBufferedInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				BufferedInputStreamReadMain::accessFileSystemViaBufferedInputStreamReadByteArrayOffsetLength,
				BufferedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaBufferedInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(BufferedInputStreamReadMain::accessFileSystemViaBufferedInputStreamReadAllBytes,
				BufferedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaBufferedInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(BufferedInputStreamReadMain::accessFileSystemViaBufferedInputStreamReadNBytes,
				BufferedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCheckedInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CheckedInputStreamReadMain::accessFileSystemViaCheckedInputStreamRead,
				CheckedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCheckedInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CheckedInputStreamReadMain::accessFileSystemViaCheckedInputStreamReadByteArray,
				CheckedInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaCheckedInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/checkedInputStream")
	void test_accessFileSystemViaCheckedInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				CheckedInputStreamReadMain::accessFileSystemViaCheckedInputStreamReadByteArrayOffsetLength,
				CheckedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCheckedInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CheckedInputStreamReadMain::accessFileSystemViaCheckedInputStreamReadAllBytes,
				CheckedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCheckedInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CheckedInputStreamReadMain::accessFileSystemViaCheckedInputStreamReadNBytes,
				CheckedInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCipherInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CipherInputStreamReadMain::accessFileSystemViaCipherInputStreamRead,
				CipherInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCipherInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CipherInputStreamReadMain::accessFileSystemViaCipherInputStreamReadByteArray,
				CipherInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaCipherInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/cipherInputStream")
	void test_accessFileSystemViaCipherInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				CipherInputStreamReadMain::accessFileSystemViaCipherInputStreamReadByteArrayOffsetLength,
				CipherInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCipherInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CipherInputStreamReadMain::accessFileSystemViaCipherInputStreamReadAllBytes,
				CipherInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaCipherInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(CipherInputStreamReadMain::accessFileSystemViaCipherInputStreamReadNBytes,
				CipherInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDeflaterInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DeflaterInputStreamReadMain::accessFileSystemViaDeflaterInputStreamRead,
				DeflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDeflaterInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				DeflaterInputStreamReadMain::accessFileSystemViaDeflaterInputStreamReadByteArray,
				DeflaterInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaDeflaterInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/deflaterInputStream")
	void test_accessFileSystemViaDeflaterInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				DeflaterInputStreamReadMain::accessFileSystemViaDeflaterInputStreamReadByteArrayOffsetLength,
				DeflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDeflaterInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DeflaterInputStreamReadMain::accessFileSystemViaDeflaterInputStreamReadAllBytes,
				DeflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDeflaterInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DeflaterInputStreamReadMain::accessFileSystemViaDeflaterInputStreamReadNBytes,
				DeflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDigestInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DigestInputStreamReadMain::accessFileSystemViaDigestInputStreamRead,
				DigestInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDigestInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DigestInputStreamReadMain::accessFileSystemViaDigestInputStreamReadByteArray,
				DigestInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaDigestInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/digestInputStream")
	void test_accessFileSystemViaDigestInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				DigestInputStreamReadMain::accessFileSystemViaDigestInputStreamReadByteArrayOffsetLength,
				DigestInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDigestInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DigestInputStreamReadMain::accessFileSystemViaDigestInputStreamReadAllBytes,
				DigestInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDigestInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DigestInputStreamReadMain::accessFileSystemViaDigestInputStreamReadNBytes,
				DigestInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamRead,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileCacheImageInputStreamReadByteArray">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileCacheImageInputStream")
	void test_accessFileSystemViaFileCacheImageInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadByteArray,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileCacheImageInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileCacheImageInputStream")
	void test_accessFileSystemViaFileCacheImageInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadByteArrayOffsetLength,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadFullyMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadFully,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileCacheImageInputStreamReadFullyWithOffset">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileCacheImageInputStream")
	void test_accessFileSystemViaFileCacheImageInputStreamReadFullyWithOffsetMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadFullyWithOffset,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadBooleanMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadBoolean,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadByte,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileCacheImageInputStreamReadUnsignedByte">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileCacheImageInputStream")
	void test_accessFileSystemViaFileCacheImageInputStreamReadUnsignedByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadUnsignedByte,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadCharMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadChar,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadDoubleMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadDouble,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadFloatMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadFloat,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadLongMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadLong,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileCacheImageInputStreamReadShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadShort,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileCacheImageInputStreamReadUnsignedShort">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileCacheImageInputStream")
	void test_accessFileSystemViaFileCacheImageInputStreamReadUnsignedShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileCacheImageInputStreamReadMain::accessFileSystemViaFileCacheImageInputStreamReadUnsignedShort,
				FileCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamRead,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadByteArray,
				FileImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileImageInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileImageInputStream")
	void test_accessFileSystemViaFileImageInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadByteArrayOffsetLength,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadFullyMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadFully,
				FileImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFileImageInputStreamReadFullyWithOffset">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/fileImageInputStream")
	void test_accessFileSystemViaFileImageInputStreamReadFullyWithOffsetMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadFullyWithOffset,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadBooleanMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadBoolean,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadByte,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadUnsignedByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadUnsignedByte,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadCharMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadChar,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadDoubleMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadDouble,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadFloatMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadFloat,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadLongMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadLong,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadShort,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFileImageInputStreamReadUnsignedShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FileImageInputStreamReadMain::accessFileSystemViaFileImageInputStreamReadUnsignedShort,
				FileImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFilterInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilterInputStreamReadMain::accessFileSystemViaFilterInputStreamRead,
				FilterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFilterInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilterInputStreamReadMain::accessFileSystemViaFilterInputStreamReadByteArray,
				FilterInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaFilterInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/filterInputStream")
	void test_accessFileSystemViaFilterInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				FilterInputStreamReadMain::accessFileSystemViaFilterInputStreamReadByteArrayOffsetLength,
				FilterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFilterInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilterInputStreamReadMain::accessFileSystemViaFilterInputStreamReadAllBytes,
				FilterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFilterInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilterInputStreamReadMain::accessFileSystemViaFilterInputStreamReadNBytes,
				FilterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaGZIPInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(GZIPInputStreamReadMain::accessFileSystemViaGZIPInputStreamRead,
				GZIPInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaGZIPInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(GZIPInputStreamReadMain::accessFileSystemViaGZIPInputStreamReadByteArray,
				GZIPInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaGZIPInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/gZIPInputStream")
	void test_accessFileSystemViaGZIPInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				GZIPInputStreamReadMain::accessFileSystemViaGZIPInputStreamReadByteArrayOffsetLength,
				GZIPInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaGZIPInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(GZIPInputStreamReadMain::accessFileSystemViaGZIPInputStreamReadAllBytes,
				GZIPInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaGZIPInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(GZIPInputStreamReadMain::accessFileSystemViaGZIPInputStreamReadNBytes,
				GZIPInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplRead,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadByteArray,
				ImageInputStreamImplReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaImageInputStreamImplReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/imageInputStreamImpl")
	void test_accessFileSystemViaImageInputStreamImplReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadByteArrayOffsetLength,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadFullyMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadFully,
				ImageInputStreamImplReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaImageInputStreamImplReadFullyWithOffset">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/imageInputStreamImpl")
	void test_accessFileSystemViaImageInputStreamImplReadFullyWithOffsetMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadFullyWithOffset,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadBooleanMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadBoolean,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadByte,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadUnsignedByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadUnsignedByte,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadCharMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadChar,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadDoubleMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadDouble,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadFloatMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadFloat,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadLongMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadLong,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadShort,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaImageInputStreamImplReadUnsignedShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ImageInputStreamImplReadMain::accessFileSystemViaImageInputStreamImplReadUnsignedShort,
				ImageInputStreamImplReadMain.class);
	}
	...
	void test_accessFileSystemViaInflaterInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(InflaterInputStreamReadMain::accessFileSystemViaInflaterInputStreamRead,
				InflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaInflaterInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				InflaterInputStreamReadMain::accessFileSystemViaInflaterInputStreamReadByteArray,
				InflaterInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaInflaterInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/inflaterInputStream")
	void test_accessFileSystemViaInflaterInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				InflaterInputStreamReadMain::accessFileSystemViaInflaterInputStreamReadByteArrayOffsetLength,
				InflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaInflaterInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(InflaterInputStreamReadMain::accessFileSystemViaInflaterInputStreamReadAllBytes,
				InflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaInflaterInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(InflaterInputStreamReadMain::accessFileSystemViaInflaterInputStreamReadNBytes,
				InflaterInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaJarInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(JarInputStreamReadMain::accessFileSystemViaJarInputStreamRead,
				JarInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaJarInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(JarInputStreamReadMain::accessFileSystemViaJarInputStreamReadByteArray,
				JarInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaJarInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/jarInputStream")
	void test_accessFileSystemViaJarInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				JarInputStreamReadMain::accessFileSystemViaJarInputStreamReadByteArrayOffsetLength,
				JarInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaJarInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(JarInputStreamReadMain::accessFileSystemViaJarInputStreamReadAllBytes,
				JarInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaJarInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(JarInputStreamReadMain::accessFileSystemViaJarInputStreamReadNBytes,
				JarInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaLineNumberInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(LineNumberInputStreamReadMain::accessFileSystemViaLineNumberInputStreamRead,
				LineNumberInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaLineNumberInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				LineNumberInputStreamReadMain::accessFileSystemViaLineNumberInputStreamReadByteArray,
				LineNumberInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaLineNumberInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/lineNumberInputStream")
	void test_accessFileSystemViaLineNumberInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				LineNumberInputStreamReadMain::accessFileSystemViaLineNumberInputStreamReadByteArrayOffsetLength,
				LineNumberInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaLineNumberInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				LineNumberInputStreamReadMain::accessFileSystemViaLineNumberInputStreamReadAllBytes,
				LineNumberInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaLineNumberInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				LineNumberInputStreamReadMain::accessFileSystemViaLineNumberInputStreamReadNBytes,
				LineNumberInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamRead,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaMemoryCacheImageInputStreamReadByteArray">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/memoryCacheImageInputStream")
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadByteArray,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaMemoryCacheImageInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/memoryCacheImageInputStream")
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadByteArrayOffsetLength,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadFullyMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadFully,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaMemoryCacheImageInputStreamReadFullyWithOffset">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/memoryCacheImageInputStream")
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadFullyWithOffsetMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadFullyWithOffset,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaMemoryCacheImageInputStreamReadBoolean">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/memoryCacheImageInputStream")
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadBooleanMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadBoolean,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadByte,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaMemoryCacheImageInputStreamReadUnsignedByte">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/memoryCacheImageInputStream")
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadUnsignedByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadUnsignedByte,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadCharMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadChar,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadDoubleMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadDouble,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadFloatMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadFloat,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadLongMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadLong,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadShort,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaMemoryCacheImageInputStreamReadUnsignedShort">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/memoryCacheImageInputStream")
	void test_accessFileSystemViaMemoryCacheImageInputStreamReadUnsignedShortMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				MemoryCacheImageInputStreamReadMain::accessFileSystemViaMemoryCacheImageInputStreamReadUnsignedShort,
				MemoryCacheImageInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaObjectInputStreamReadMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ObjectInputStreamReadMain::accessFileSystemViaObjectInputStreamRead,
				ObjectInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaObjectInputStreamReadByteArrayMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ObjectInputStreamReadMain::accessFileSystemViaObjectInputStreamReadByteArray,
				ObjectInputStreamReadMain.class);
	}
	...
	// <editor-fold
	// desc="accessFileSystemViaObjectInputStreamReadByteArrayOffsetLength">
	@PublicTest
	@Policy(value = ARCHUNIT_ASPECTJ_POLICY_ONE_PATH_ALLOWED_READ, withinPath = "test-classes/de/tum/cit/ase/ares/integration/aop/forbidden/subject/fileSystem/read/inputStream/objectInputStream")
	void test_accessFileSystemViaObjectInputStreamReadByteArrayOffsetLengthMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(
				ObjectInputStreamReadMain::accessFileSystemViaObjectInputStreamReadByteArrayOffsetLength,
				ObjectInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaObjectInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ObjectInputStreamReadMain::accessFileSystemViaObjectInputStreamReadAllBytes,
				ObjectInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaObjectInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(ObjectInputStreamReadMain::accessFileSystemViaObjectInputStreamReadNBytes,
				ObjectInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaFilesMovePathMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(FilesReadMain::accessFileSystemViaFilesMovePath, FilesReadMain.class);
	}
	...
	void test_accessFileSystemViaDataInputStreamReadAllBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DataInputStreamReadMain::accessFileSystemViaDataInputStreamReadAllBytes,
	...
	void test_accessFileSystemViaDataInputStreamReadNBytesMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DataInputStreamReadMain::accessFileSystemViaDataInputStreamReadNBytes,
				DataInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDataInputStreamReadByteMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DataInputStreamReadMain::accessFileSystemViaDataInputStreamReadByte,
				DataInputStreamReadMain.class);
	}
	...
	void test_accessFileSystemViaDataInputStreamReadFullyWithOffsetMavenArchunitAspectJ() {
		assertAresSecurityExceptionRead(DataInputStreamReadMain::accessFileSystemViaDataInputStreamReadFullyWithOffset,
				DataInputStreamReadMain.class);
	}
