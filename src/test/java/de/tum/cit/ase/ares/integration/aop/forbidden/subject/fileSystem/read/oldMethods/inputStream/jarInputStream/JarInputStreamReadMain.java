package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.jarInputStream;
...
public class JarInputStreamReadMain {
	...
	public static int accessFileSystemViaJarInputStreamRead() throws IOException {
		try (JarInputStream reader = new JarInputStream(new FileInputStream(
