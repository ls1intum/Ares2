package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.filterInputStream;
...
public class FilterInputStreamReadMain {
	...
	public static int accessFileSystemViaFilterInputStreamRead() throws IOException {
		try (FilterInputStream reader = new BufferedInputStream(new FileInputStream(
