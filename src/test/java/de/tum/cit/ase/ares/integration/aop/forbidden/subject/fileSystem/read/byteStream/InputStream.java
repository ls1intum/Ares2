...
public class InputStream {
	...
	/**
	 * Access the file system using InputStream.read() method. Test Case:
	 * InputStream.read() - Read one byte; returns -1 at EOF
	 */
	...
	/**
	 * Access the file system using InputStream.available() method. Test Case:
	 * InputStream.available() - Bytes that can be read without blocking
	 */
	...
	/**
	 * Access the file system using InputStream.readAllBytes() method. Test Case:
	 * InputStream.readAllBytes() - Slurp the whole file into a byte[]
	 */
