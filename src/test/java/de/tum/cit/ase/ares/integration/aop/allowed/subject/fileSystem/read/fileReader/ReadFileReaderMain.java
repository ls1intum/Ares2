...
public class ReadFileReaderMain {
	...
	/**
	 * Access the file system using FileReader.read() Reads the file character by
	 * character.
	 */
	...
	/**
	 * Access the file system using FileReader.read(char[] cbuf) Reads the file into
	 * a character buffer.
	 */
	...
	/**
	 * Access the file system using FileReader(File file, Charset charset)
	 * constructor.
	 */
	...
	/**
	 * Access the file system using FileReader(String fileName, Charset charset)
	 * constructor.
	 */
