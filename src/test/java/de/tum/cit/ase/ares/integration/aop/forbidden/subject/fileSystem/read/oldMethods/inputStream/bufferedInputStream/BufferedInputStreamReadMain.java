package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.inputStream.bufferedInputStream;
...
public class BufferedInputStreamReadMain {
	...
	public static int accessFileSystemViaBufferedInputStreamRead() throws IOException {
		try (BufferedInputStream reader = new BufferedInputStream(new FileInputStream(
