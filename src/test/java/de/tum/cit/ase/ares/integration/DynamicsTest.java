...
class DynamicsTest {
	...
	void test_checks_fail() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(checks_fail, MultipleFailuresError.class, //
				"Multiple Failures (6 failures)\n" //
						+ "	org.opentest4j.AssertionFailedError: Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass ist public.\n" //
						+ "	org.opentest4j.AssertionFailedError: Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass ist nicht final.\n" //
						+ "	org.opentest4j.AssertionFailedError: Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass ist nicht statisch.\n" //
						+ "	org.opentest4j.AssertionFailedError: Attribut de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass.[someAttribute] ist nicht public.\n" //
						+ "	org.opentest4j.AssertionFailedError: Attribut de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass.[SOME_CONSTANT] ist final.\n" //
						+ "	org.opentest4j.AssertionFailedError: Attribut de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass.[SOME_CONSTANT] ist statisch." //
	...
	void test_class_searchNonFinalFields() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(class_searchNonFinalFields, AssertionFailedError.class,
				"Attribut private java.lang.String de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass.someAttribute muss final sein."));
	}
	...
	void test_class_searchNonPrivateFields() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(class_searchNonPrivateFields, AssertionFailedError.class,
				"Attribut public static final int de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass.SOME_CONSTANT muss private sein."));
	}
	...
	void test_constructor_abstract() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(constructor_abstract, AssertionFailedError.class,
				"Objekt der Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeAbstractClass konnte nicht erzeugt werden, ist die Klasse abstrakt?"));
	}
	...
	void test_constructor_illegalArguments() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(constructor_illegalArguments, AssertionFailedError.class,
				"Konstruktor de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass(java.lang.Integer) konnte Argumente mit den Typen (java.lang.String) nicht entgegennehmen."));
	}
	...
	void test_constructor_notFound() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(constructor_notFound, AssertionFailedError.class,
				"Kein Konstruktor für de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass mit Parametern (java.lang.Boolean, java.lang.Boolean) gefunden."));
	}
	...
	void test_field_getStaticNull() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(field_getStaticNull, AssertionFailedError.class,
				"Attribut [someAttribute] der Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass ist nicht statisch."));
	}
	...
	void test_field_getWrongObject() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(field_getWrongObject, AssertionFailedError.class,
				"Attribut [someAttribute] von Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass wurde nicht auf einem passenden Objekt aufgerufen."));
	}
	...
	void test_field_setStaticFinal() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(field_setStaticFinal, AssertionFailedError.class,
				"Attribut [SOME_CONSTANT] der Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass kann nicht gesetzt werden, da es final ist."));
	}
	...
	void test_field_setWrongType() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(field_setWrongType, AssertionFailedError.class,
				"Attribut [someAttribute] der Klasse de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass vom Typ java.lang.String kann keine Instanz der Klasse class java.lang.Integer zugewiesen werden."));
	}
	...
	void test_method_illegalArguments() {
		tests.assertThatEvents().haveExactly(1, testFailedWith(method_illegalArguments, AssertionFailedError.class,
				"Methode de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass.doSomethingElse(int) konnte Argumente mit den Typen (java.lang.String) für Objekt vom Typ de.tum.cit.ase.ares.integration.testuser.subject.structural.SomeClass nicht entgegennehmen."));
	}
