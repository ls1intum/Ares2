...
class FileSystemAccessOverwriteTest extends SystemAccessTest {
	...
	void test_accessFileSystemViaThirdPartyPackageMavenArchunitAspectJ() {
		assertAresSecurityExceptionOverwrite(WriteThirdPartyPackageMain::accessFileSystemViaThirdPartyPackage, ThirdPartyPackagePenguin.class, NOT_TRUSTED_FILE_PATH);
	}
