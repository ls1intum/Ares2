...
import de.tum.cit.ase.ares.integration.architecture.forbidden.subject.fileSystem.overwrite.files.ArchitectureWriteFilesWriteMain;
...
class FileSystemAccessOverwriteTest extends SystemAccessTest {
	...
	private static final String FILES_WRITE_PATH = "test-classes/de/tum/cit/ase/ares/integration/architecture/forbidden/subject/fileSystem/overwrite/files";
	...
	void test_accessFileSystemViaFilesWriteMavenArchunitAspectJ_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaFilesWriteMavenArchunitAspectJ");
	}

	@Test
	void test_accessFileSystemViaFilesWriteMavenArchunitInstrumentation_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaFilesWriteMavenArchunitInstrumentation");
	}

	@Test
	void test_accessFileSystemViaFilesWriteMavenWalaAspectJ_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaFilesWriteMavenWalaAspectJ");
	}

	@Test
	void test_accessFileSystemViaFilesWriteMavenWalaInstrumentation_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaFilesWriteMavenWalaInstrumentation");
	}
	// </editor-fold>
	...
	void test_accessFileSystemViaBufferedWriterMavenArchunitAspectJ_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaBufferedWriterMavenArchunitAspectJ");
	}

	@Test
	void test_accessFileSystemViaBufferedWriterMavenArchunitInstrumentation_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaBufferedWriterMavenArchunitInstrumentation");
	}

	@Test
	void test_accessFileSystemViaBufferedWriterMavenWalaAspectJ_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaBufferedWriterMavenWalaAspectJ");
	}

	@Test
	void test_accessFileSystemViaBufferedWriterMavenWalaInstrumentation_test() {
		executeTestAndExpectSecurityException(FileSystemAccessOverwriteTest.class,
				"test_accessFileSystemViaBufferedWriterMavenWalaInstrumentation");
	}
	// </editor-fold>
	...
	void test_accessFileSystemViaFilesWriteMavenArchunitAspectJ() {
		assertAresSecurityExceptionOverwrite(ArchitectureWriteFilesWriteMain::accessFileSystemViaFilesWrite,
				ArchitectureWriteFilesWriteMain.class, NOT_TRUSTED_FILE_PATH);
	}
