...
public class InflaterOutputStreamWriteMain {
	...
	/**
	 * Access the file system using {@link InflaterOutputStream} directly for
	 * writing. (InflaterOutputStream is normally for decompression—used here only
	 * to reach the overwrite sink).
	 */
