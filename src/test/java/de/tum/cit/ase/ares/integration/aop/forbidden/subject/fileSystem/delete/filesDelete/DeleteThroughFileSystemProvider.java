...
public class DeleteThroughFileSystemProvider {
	...
	private DeleteThroughFileSystemProvider() {
		throw new SecurityException(
				"Ares Security Error (Reason: Ares-Code; Stage: Test): DeleteThroughFilesystemProvider is a utility class and should not be instantiated.");
	}
	...
	public static void accessFileSystemViaFileSystemProvider() throws IOException {
		Path target = Path.of(NOT_TRUSTED_FILE);
		FileSystemProvider provider = target.getFileSystem().provider();
