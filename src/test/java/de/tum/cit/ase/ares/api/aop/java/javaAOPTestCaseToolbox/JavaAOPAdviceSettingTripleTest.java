...
public class JavaAOPAdviceSettingTripleTest {
	...
	public void testValidConstructionAndGetters() {
		JavaAOPAdviceSettingTriple triple = new JavaAOPAdviceSettingTriple("String", "settingName", 123);
	...
	public void testValueCanBeNull() {
		JavaAOPAdviceSettingTriple triple = new JavaAOPAdviceSettingTriple("String", "setting", null);
		Assertions.assertNull(triple.value());
	}

	@Test
	public void testEqualsAndHashCode() {
		JavaAOPAdviceSettingTriple t1 = new JavaAOPAdviceSettingTriple("T", "S", 1);
		JavaAOPAdviceSettingTriple t2 = new JavaAOPAdviceSettingTriple("T", "S", 1);
		JavaAOPAdviceSettingTriple t3 = new JavaAOPAdviceSettingTriple("T", "S", 2);
	...
	public void testToStringFormat() {
		JavaAOPAdviceSettingTriple triple = new JavaAOPAdviceSettingTriple("Type", "Name", "Val");
