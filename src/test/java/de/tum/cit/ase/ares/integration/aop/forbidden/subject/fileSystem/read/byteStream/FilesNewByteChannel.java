...
public class FilesNewByteChannel {
	...
	/**
	 * Access the file system using Files.newByteChannel(Path, OpenOption...) for
	 * seekable byte channel reading. Test Case: Files.newByteChannel(Path,
	 * OpenOption...) - Open a SeekableByteChannel for scatter/gather I/O
	 */
