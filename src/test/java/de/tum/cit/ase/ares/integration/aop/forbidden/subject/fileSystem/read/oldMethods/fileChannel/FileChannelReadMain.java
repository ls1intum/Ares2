package de.tum.cit.ase.ares.integration.aop.forbidden.subject.fileSystem.read.oldMethods.fileChannel;
...
public class FileChannelReadMain {
	...
	/**
	 * Access the file system using FileChannel.read(ByteBuffer[] dsts, int offset,
	 * int length).
	 *
	 * @return number of bytes read
	 */
	...
	/**
	 * Access the file system using FileChannel.transferFrom(ReadableByteChannel
	 * src, long position, long count).
	 *
