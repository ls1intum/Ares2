...
public class JavaInstrumentationAdviceThreadSystemToolbox {
    ...
    private static <T> T getValueFromSettings(String fieldName) {
        try {
            ...
            Class<?> adviceSettingsClass = Class.forName("%s.ares.api.aop.java.JavaAOPTestCaseSettings", true, null);
    ...
    public static String localize(String key, Object... args) {
        try {
            Class<?> messagesClass = Class.forName("%s.ares.api.localization.Messages", true, Thread.currentThread().getContextClassLoader());
