 ...
 *
 * <p>Whenever an intercepted method is entered the advice extracts all instance fields
 * (if an instance is present) and forwards them together with the original parameters to
 ...
 * using the {@code create} action. The toolbox then validates whether the pending creation is
 * permitted by the active security policy.</p>
 */
