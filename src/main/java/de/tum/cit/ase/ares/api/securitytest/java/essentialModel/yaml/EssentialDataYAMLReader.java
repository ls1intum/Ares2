...
public class EssentialDataYAMLReader implements EssentialDataReader {
    ...
    public EssentialClasses readEssentialClassesFrom(@Nonnull Path essentialClassesPath) {
        @Nonnull Path path = Preconditions.checkNotNull(essentialClassesPath, "The essential classes path must not be null!");
        @Nonnull Class<EssentialClasses> yamlClass = Preconditions.checkNotNull(EssentialClasses.class, "The essential classes class must not be null!");
        try {
    ...
    public EssentialPackages readEssentialPackagesFrom(@Nonnull Path essentialPackagesPath) {
        @Nonnull Path path =  Preconditions.checkNotNull(essentialPackagesPath, "The essential packages path must not be null!");
        @Nonnull Class<EssentialPackages> yamlClass = Preconditions.checkNotNull(EssentialPackages.class, "The essential packages class must not be null!");
        try {
            return FileTools.readYamlFile(FileTools.readFile(path), yamlClass);
        } catch (StreamReadException e) {
