...
/**
 * This class provides advice for the execution of constructors that can execute
 * commands. It is responsible for verifying whether the constructor execution
 * is allowed based on the command system security policies defined within the
 * application.
 * <p>
...
public final class JavaInstrumentationExecuteCommandConstructorAdvice {
	 ...
	 * execution is allowed according to command system security policies. If the
	...
	public static void onEnter(@Advice.Origin("#t") String declaringTypeName, @Advice.AllArguments Object... parameters) {
		...
		JavaInstrumentationAdviceCommandSystemToolbox.checkCommandSystemInteraction("execute", declaringTypeName, "<init>", "", new Object[0], parameters);
	}
}
