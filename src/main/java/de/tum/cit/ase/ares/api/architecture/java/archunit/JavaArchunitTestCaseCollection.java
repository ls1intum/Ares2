...
public class JavaArchunitTestCaseCollection {
	...
	private JavaArchunitTestCaseCollection() {
		throw new SecurityException(Messages.localized("security.general.utility.initialization", JavaArchunitTestCaseCollection.class.getSimpleName()));
	}
	// </editor-fold>
	...
	private static ArchRule createNoClassShouldHaveMethodRule(String ruleName, Path methodsFilePath) {
		return ArchRuleDefinition.noClasses().should(new TransitivelyAccessesMethodsCondition(new DescribedPredicate<>(ruleName) {
			...
			public boolean test(JavaAccess<?> javaAccess) {
				...
				return forbiddenMethods.stream().filter(method -> !method.isEmpty()).anyMatch(method -> javaAccess.getTarget().getFullName().startsWith(method));
			}
		})).as(ruleName);
	}
	// </editor-fold>
	 ...
	 * system.
	 */
	public static final ArchRule NO_CLASS_MUST_ACCESS_FILE_SYSTEM = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.file.system.access"),
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_ACCESS_NETWORK = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.network.access"),
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_CREATE_THREADS = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.manipulate.threads"),
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_EXECUTE_COMMANDS = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.execute.command"),
	...
	public static ArchRule noClassMustImportForbiddenPackages(Set<PackagePermission> allowedPackages) {
		return ArchRuleDefinition.noClasses().should().dependOnClassesThat(new DescribedPredicate<>("imports a forbidden package package") {
			@Override
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_USE_REFLECTION = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.reflection.uses"),
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_TERMINATE_JVM = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.terminate.jvm"),
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_SERIALIZE = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.serialize"),
	 ...
	 */
	public static final ArchRule NO_CLASS_MUST_USE_CLASSLOADERS = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.class.loading"),
