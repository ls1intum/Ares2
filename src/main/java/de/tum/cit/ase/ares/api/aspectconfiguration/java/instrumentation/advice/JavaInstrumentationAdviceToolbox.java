...
public class JavaInstrumentationAdviceToolbox {
    ...
    private static Object getValueFromSettings(String fieldName) {
        try {
            Class<?> adviceSettingsClass = Class.forName("de.tum.cit.ase.ares.api.aspectconfiguration.java.instrumentation.JavaInstrumentationConfigurationSettings", true, null);
