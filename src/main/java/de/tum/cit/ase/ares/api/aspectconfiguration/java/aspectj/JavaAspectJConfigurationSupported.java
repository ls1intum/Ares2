package de.tum.cit.ase.ares.api.aspectconfiguration.java.aspectj;

/**
 * Enum representing the supported aspect configurations in the Java programming language using AspectJ.
 * <p>
 * This enum defines the different types of aspect configurations that are supported for
 * AspectJ in Java. These configurations are used to control and manage different
 ...
 * @since 2.0.0
 */
public enum JavaAspectJConfigurationSupported {
