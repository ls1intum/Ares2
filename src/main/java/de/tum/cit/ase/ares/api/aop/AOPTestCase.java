...
public abstract class AOPTestCase {
	...
	/**
	 * Defines the type of aop test case used in this test case. Determines which
	 * aop rules and validations will be applied during analysis of this test case.
	 */
	@Nonnull
	...
	/**
	 * Writes the content of the AOP test cases for the provided architecture mode
	 * and AOP mode.
	 *
	 * @since 2.0.0
	 * @author Markus Paulsen
