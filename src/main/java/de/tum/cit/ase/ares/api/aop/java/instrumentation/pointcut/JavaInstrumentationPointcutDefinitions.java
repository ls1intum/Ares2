...
public class JavaInstrumentationPointcutDefinitions {
    ...
    public static final Map<String, List<String>> methodsWhichCanReadFiles = Map.ofEntries(
            ...
            Map.entry("java.nio.file.spi.FileSystemProvider", List.of("checkAccess", "getFileAttributeView", "getFileStore", "getFileSystem", "getScheme", "isHidden", "isSameFile", "readAttributes", "readSymbolicLink")),
            // java.util
