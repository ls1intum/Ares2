 ...
 * agent. These pointcuts are used to identify methods that perform file system
 * operations (e.g., read, write, execute, delete) and apply security checks
 * using bytecode modification. The methods in this class define which file
...
public class JavaInstrumentationPointcutDefinitions {
	 ...
	 * </ul>
	 * <p>
	 * The resulting matcher is effectively:
	 * </p>
	 * 
	 * <pre>
	 ...
	 */
	public static ElementMatcher<TypeDescription> getClassesMatcher(Map<String, List<String>> methodsMap) {
		String[] targets = methodsMap.keySet().stream().distinct().toArray(String[]::new);
	 ...
	 * constructors) or {@code "<init>(...signature...)"} to restrict
	 * instrumentation to specific parameter types.
	 * </p>
	 *
	...
	/**
	 * This map contains the methods which can read files. The map keys represent
	...
	public static final Map<String, List<String>> methodsWhichCanReadFiles = Map.ofEntries(
			...
			Map.entry("java.util.zip.ZipInputStream", List.of("<init>", "getNextEntry")),
	...
	/**
	 * This map contains the methods which can overwrite files. The map keys
	...
	public static final Map<String, List<String>> methodsWhichCanOverwriteFiles = Map.ofEntries(
			...
			// false positives. File access is already blocked at constructor level.
			Map.entry("java.io.Writer", List.of("<init>")),
	...
	/**
	 * This map contains the methods which can execute files. The map keys represent
	 * class names, and the values are lists of method names that are considered to
	 * be file execute operations. Note: Runtime.exec and
	...
	/**
	 * This map contains the methods which can delete files. The map keys represent
	 * class names, and the values are lists of method names that are considered to
	...
	/**
	 * This map contains the methods which can create threads. The map keys
	 * represent class names, and the values are lists of method names that are
	...
	/**
	 * This map contains the methods which can execute commands. The map keys
	 * represent class names, and the values are lists of method names that are
