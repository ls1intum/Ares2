...
/**
 * This class provides advice for the execution of constructors overwriting
 * files. It is responsible for verifying whether the constructor execution is
 * allowed based on the file system security policies defined within the
 * application.
 * <p>
 * If an execution attempt violates these policies, a SecurityException is
 * thrown, preventing unauthorised file overwriting. The class interacts with
...
public final class JavaInstrumentationOverwritePathConstructorAdvice {
	...
	public static void onEnter(@Advice.Origin("#t") String declaringTypeName,
		...
		JavaInstrumentationAdviceFileSystemToolbox.checkFileSystemInteraction("overwrite", declaringTypeName, "<init>",
