...
public class UnwantedRecursionAssert extends AbstractAssert<UnwantedRecursionAssert, Path> {
	...
	/**
	 * The method to start the recursion check from, not optional since Optional
	 * type is not recommended for field types
	 */
	...
	/**
	 * Creates an unwanted simple recursion assertion object for all project source
	 * files.
	 * <p>
	...
	/**
	 * Creates an unwanted simple recursion node assertion object for all source
	 * files at and below the given directory path.
	 *
	...
	/**
	 * Creates an unwanted simple recursion assertion object for all source files in
