...
public class JavaAOPTestCaseSettings {
    ...
    private JavaAOPTestCaseSettings() {
        throw new SecurityException("Ares Security Error (Reason: Ares-Code; Stage: Creation): JavaTestCaseSettings is a utility class and should not be instantiated.");
    }
