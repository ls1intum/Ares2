 ...
 * {@link de.tum.cit.ase.ares.api.TrustedThreads TrustedThreads} must be configured
 * to {@link de.tum.cit.ase.ares.api.TrustedThreads.TrustScope#EXTENDED
 * EXTENDED}.</b> This comes with security implications and only changing the
 * scope is not sufficient. For more details, see
 * {@link de.tum.cit.ase.ares.api.TrustedThreads TrustedThreads}. The reason here is
 ...
 * {@link de.tum.cit.ase.ares.api.TrustedThreads.TrustScope#ALL_THREADS ALL_THREADS}
