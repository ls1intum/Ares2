...
/**
 * This class provides advice for the execution of constructors creating
 * threads. It is responsible for verifying whether the constructor execution is
 * allowed based on the thread system security policies defined within the
 * application.
 * <p>
...
public final class JavaInstrumentationCreateThreadConstructorAdvice {
	 ...
	 * allowed according to thread system security policies. If the constructor
	...
	public static void onEnter(@Advice.Origin("#t") String declaringTypeName, @Advice.AllArguments Object... parameters) {
		...
		JavaInstrumentationAdviceThreadSystemToolbox.checkThreadSystemInteraction("create", declaringTypeName, "<init>", "", new Object[0], parameters);
	}
}
