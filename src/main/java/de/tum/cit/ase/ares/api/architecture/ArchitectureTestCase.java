...
public abstract class ArchitectureTestCase {
	...
	/**
	 * Defines the type of architecture test case used in this test case. Determines
	 * which architectural rules and validations will be applied during analysis of
	 * this test case.
	 */
	@Nonnull
	...
	/**
	 * Set of package permissions that are allowed to be imported or accessed by the
	 * code under test in this test case. When empty, no package restrictions are
	 * enforced.
	 */
	@Nonnull
	...
	/**
	 * Constructs a new abstract architecture test case with the specified
	 * parameters.
	 *
	 * @since 2.0.0
	...
	/**
	 * Writes the content of the architecture test cases for the provided
	 * architecture mode and AOP mode.
	 *
	 * @since 2.0.0
	 * @author Markus Paulsen
	...
	/**
	 * Executes the architecture test cases for the provided architecture mode and
	 * AOP mode.
	 *
	 * @since 2.0.0
	 * @author Markus Paulsen
