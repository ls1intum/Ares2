...
public class JavaWalaTestCaseCollection {
	...
	public static final WalaRule NO_CLASS_MUST_ACCESS_NETWORK = createNoClassShouldHaveMethodRule(
			Messages.localized("security.architecture.network.access"), FileHandlerConstants.WALA_NETWORK_METHODS);
	// </editor-fold>
	...
	public static final WalaRule NO_CLASS_MUST_USE_REFLECTION = createNoClassShouldHaveMethodRule(
			Messages.localized("security.architecture.reflection.uses"), FileHandlerConstants.WALA_REFLECTION_METHODS);
	// </editor-fold>
	...
	public static final WalaRule NO_CLASS_MUST_SERIALIZE = createNoClassShouldHaveMethodRule(
			Messages.localized("security.architecture.serialize"), FileHandlerConstants.WALA_SERIALIZATION_METHODS);
	// </editor-fold>
