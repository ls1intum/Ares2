...
public class JavaWalaTestCaseCollection {
	...
	private JavaWalaTestCaseCollection() {
		throw new SecurityException(Messages.localized("security.general.utility.initialization", JavaWalaTestCaseCollection.class.getSimpleName()));
	}
	// </editor-fold>
	...
	private static WalaRule createNoClassShouldHaveMethodRule(String ruleName, Path methodsFilePath) {
		return wrapIgnoringJdkHelpers(new WalaRule(ruleName, FileTools.readMethodsFile(FileTools.readFile(methodsFilePath))));
	}
	...
	private static final List<String> JDK_THREAD_HELPERS = List.of(
			...
			"Lsun/nio/fs/", "sun/nio/fs/", "Lsun/nio/ch/", "sun/nio/ch/", "Ljava/nio/file/Files", "java/nio/file/Files", "Ljava/lang/ClassLoader", "java/lang/ClassLoader", "Ljava/lang/Class",
			"java/lang/Class", "Ljdk/internal/loader/NativeLibraries", "jdk/internal/loader/NativeLibraries", "Ljava/net/InetAddress", "java/net/InetAddress", "Ljava/lang/Thread", "java/lang/Thread",
			"Ljava/lang/reflect/Method", "java/lang/reflect/Method");

	private static final List<String> ALLOWED_HELPER_APIS = List.of("java.lang.Thread.<init>", "java.lang.Thread.interrupt", "java.lang.ClassLoader.getSystemClassLoader",
			"java.lang.ClassLoader.loadLibrary", "java.lang.Runtime.load", "java.lang.Runtime.loadLibrary", "java.io.File.getName", "java.lang.Class.forName", "java.net.InetAddress.getAllByName",
			"java.lang.Thread.contextClassLoader", "java.lang.Class.getDeclaredField", "java.lang.reflect.Method.invoke", "java.lang.Class.checkMemberAccess", "java.lang.Thread.getContextClassLoader",
			"java.lang.Thread.getStackTrace", "java.io.File.<init>", "java.lang.Class.getClassLoader");
		...
		return new WalaRule(base.ruleName, base.forbiddenMethods) {
			...
			public void check(CallGraph cg) {
				...
				List<CGNode> path = ReachabilityChecker.findReachableMethods(cg, cg.getEntrypointNodes().iterator(),
						n -> base.forbiddenMethods.stream().anyMatch(sig -> n.getMethod().getSignature().startsWith(sig)));
				...
				boolean helperApi = ALLOWED_HELPER_APIS.stream().anyMatch(sig -> forbidden.getMethod().getSignature().startsWith(sig));
	 ...
	 * system.
	 */
	public static final WalaRule NO_CLASS_MUST_ACCESS_FILE_SYSTEM = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.file.system.access"),
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_ACCESS_NETWORK = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.network.access"),
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_CREATE_THREADS = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.manipulate.threads"),
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_EXECUTE_COMMANDS = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.execute.command"),
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_USE_REFLECTION = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.reflection.uses"),
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_TERMINATE_JVM = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.terminate.jvm"),
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_SERIALIZE = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.serialize"), FileHandlerConstants.WALA_SERIALIZATION_METHODS);
	// </editor-fold>
	 ...
	 */
	public static final WalaRule NO_CLASS_MUST_USE_CLASSLOADERS = createNoClassShouldHaveMethodRule(Messages.localized("security.architecture.class.loading"),
