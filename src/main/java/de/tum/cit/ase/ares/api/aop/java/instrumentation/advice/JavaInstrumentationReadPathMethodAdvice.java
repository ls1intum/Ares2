...
/**
 * This class provides advice for the execution of methods reading files. It is
 ...
 * thrown, preventing unauthorized file readings. The class interacts with the
 * JavaInstrumentationAdviceFileSystemToolbox to perform these security checks.
 */
public final class JavaInstrumentationReadPathMethodAdvice {
	private JavaInstrumentationReadPathMethodAdvice() {
		throw new SecurityException(JavaInstrumentationAdviceAbstractToolbox.localize(
				"security.instrumentation.utility.initialization", "JavaInstrumentationReadPathMethodAdvice"));
	}

	/**
	 * This method is called when a method reading files is entered. It performs
	...
	public static void onEnter(@Advice.Origin("#t") String declaringTypeName, @Advice.Origin("#m") String methodName,
		...
		JavaInstrumentationAdviceFileSystemToolbox.checkFileSystemInteraction("read", declaringTypeName, methodName,
