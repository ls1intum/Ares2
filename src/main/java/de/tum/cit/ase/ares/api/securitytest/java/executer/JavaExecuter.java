...
public class JavaExecuter implements Executer {
	 ...
	 */
	private void setJavaAdviceSettingValue(@Nonnull String key, @Nullable Object value, @Nonnull ArchitectureMode architectureMode, @Nonnull AOPMode aopMode) {
	 ...
	 */
	@Override
	public void executeTestCases(@Nonnull BuildMode buildMode, @Nonnull ArchitectureMode architectureMode, @Nonnull AOPMode aopMode, @Nonnull List<String> essentialPackages,
			...
			@Nonnull List<JavaArchitectureTestCase> javaArchitectureTestCases, @Nonnull List<JavaAOPTestCase> javaAOPTestCases) {
		@Nonnull
		...
		Map.ofEntries(Map.entry("buildMode", buildModeString), Map.entry("architectureMode", architectureModeString), Map.entry("aopMode", aopModeString),
				Map.entry("allowedListedPackages", essentialPackages.toArray(String[]::new)),
				Map.entry("allowedListedClasses", Stream.concat(essentialClasses.stream(), testClasses.stream()).toArray(String[]::new)), Map.entry("restrictedPackage", packageName),
				Map.entry("mainClass", mainClassInPackageName)).forEach((key, value) -> setJavaAdviceSettingValue(key, value, architectureMode, aopMode));
