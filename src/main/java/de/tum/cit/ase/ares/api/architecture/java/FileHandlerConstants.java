...
public class FileHandlerConstants {
    ...
    public static final Path ARCHUNIT_THREAD_MANIPULATION_METHODS = FileTools.resolveFileOnSourceDirectory("templates", "architecture" , "java", "archunit", "methods", "thread-manipulation-methods.txt");
    ...
    public static final Path FALSE_POSITIVES_FILE_SYSTEM_INTERACTIONS = FileTools.resolveFileOnSourceDirectory("templates", "architecture" , "java", "wala", "false-positives", "false-positives-file.txt");
    //</editor-fold>
