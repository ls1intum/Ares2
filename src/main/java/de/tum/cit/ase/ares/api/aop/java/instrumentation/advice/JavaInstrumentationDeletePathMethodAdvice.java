...
/**
 * This class provides advice for the execution of methods deleting files. It is
 ...
 * thrown, preventing unauthorized file deletions. The class interacts with the
...
public final class JavaInstrumentationDeletePathMethodAdvice {
	...
	public static void onEnter(@Advice.Origin("#t") String declaringTypeName, @Advice.Origin("#m") String methodName, @Advice.Origin("#s") String methodSignature,
		...
		JavaInstrumentationAdviceFileSystemToolbox.checkFileSystemInteraction("delete", declaringTypeName, methodName, methodSignature, attributes, parameters, instance);
		// </editor-fold>
	}
}
