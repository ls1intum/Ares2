...
/**
 * This class provides advice for the execution of constructors sending network
 * data. It is responsible for verifying whether the constructor execution is
 * allowed based on the network system security policies defined within the
 * application.
 * <p>
...
public final class JavaInstrumentationSendNetworkConstructorAdvice {
	private JavaInstrumentationSendNetworkConstructorAdvice() {
		throw new SecurityException(JavaInstrumentationAdviceAbstractToolbox.localize(
				"security.instrumentation.utility.initialization", "JavaInstrumentationSendNetworkConstructorAdvice"));
	}
