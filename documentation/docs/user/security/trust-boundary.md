...
sidebar_position: 6
description: "What Ares 2 trusts, and the one rule student code must never break."
---
...
check described in [Postcompile Mode](./postcompile.md#3-what-you-need-to-do-outside-ares-2)
...
[enforcement model](/developer/policy/enforcement-model) in the developer guide.
