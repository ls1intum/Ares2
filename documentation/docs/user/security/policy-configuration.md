...
sidebar_position: 2
description: "The security-policy.yaml file: an annotated example, the meaning of each field, and the eight supported programming language configurations."
---
...
[Security Policy Manual](./policy-manual.md).
:::
