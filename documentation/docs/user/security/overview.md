...
sidebar_position: 1
description: "Advanced blocking with AOP, AspectJ, instrumentation and architecture testing, and the difference between precompile and postcompile mode."
---
...
See [Precompile Mode](./precompile.md) for the integration steps.
...
See [Postcompile Mode](./postcompile.md) for the integration steps.
...
[enforcement model](/developer/policy/enforcement-model), the
[AOP layer](/developer/aop/block-file-system-access) and the
[architecture analysis layer](/developer/architecture/block-file-system-access).
:::
