...
sidebar_position: 4
description: "Integrating postcompile mode: providing a configuration, annotating a test with @Policy, and the build-side work Ares 2 cannot do for you."
---
...
[Security trust boundary](./trust-boundary.md).
:::
...
[enforcement model](/developer/policy/enforcement-model). The executable snippets ship inside
