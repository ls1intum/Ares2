...
sidebar_position: 4
description: "The @Public, @Hidden, @PublicTest, @HiddenTest and @Deadline annotations, and how deadlines are resolved."
---
...
- [`@ActivateHiddenBefore`](./options.md#testing-the-exercise-before-release) — run hidden
  tests while authoring the exercise
- [`@ExtendedDeadline`](./options.md#extending-a-deadline-and-disability-compensation) —
