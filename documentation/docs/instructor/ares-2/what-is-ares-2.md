...
| Write a policy file | [Policy Configuration](../protect-a-java-project/policy-configuration.md) and the [Security Policy Manual](/maintainer/subsystems/policy/security-policy-manual) |
...
| Understand how Ares 2 works internally | The [Developer Guide](/maintainer/subsystems/package-overview) |
